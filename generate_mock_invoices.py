...
try:
    ...
    font_misa_title = ImageFont.truetype("arialbd.ttf", 26)
except IOError:
...
def draw_default(d, data):
    # Header
    d.text((280, 50), "HÓA ĐƠN GIÁ TRỊ GIA TĂNG", fill=(0, 0, 0), font=font_title)
    d.text((340, 90), "(Bản thể hiện của hóa đơn điện tử)", fill=(0, 0, 0), font=font_text)
    ...
    # Seller
    d.text((50, 130), "Đơn vị bán: CÔNG TY CỔ PHẦN CÔNG NGHỆ AI-INVOICE", fill=(0, 0, 0), font=font_bold)
    ...
    d.line([(50, 260), (850, 260)], fill=(0, 0, 0), width=2)
    ...
    d.line([(50, 410), (850, 410)], fill=(0, 0, 0), width=2)
    ...
    d.line([(50, 560), (850, 560)], fill=(0, 0, 0), width=2)
    ...
    d.text((600, 620), "Tiền thuế:", fill=(0, 0, 0), font=font_bold)
...
def draw_misa(d, data):
    d.rectangle([(0,0), (900, 120)], fill=(230, 240, 250))
    d.text((280, 20), "HÓA ĐƠN GIÁ TRỊ GIA TĂNG", fill=(0, 50, 150), font=font_misa_title)
    d.text((380, 60), "(MISA Template)", fill=(100, 100, 100), font=font_text)
    ...
    d.line([(50, 240), (850, 240)], fill=(0, 50, 150), width=2)
    ...
    d.line([(50, 500), (850, 500)], fill=(0, 50, 150), width=1)
...
def draw_fast(d, data):
    d.text((50, 50), "HÓA ĐƠN ĐIỆN TỬ (FAST)", fill=(0, 0, 0), font=font_title)
    ...
    d.text((500, 490), f"Tổng cộng tiền thanh toán: {data['total']:,}", fill=(0, 0, 0), font=font_bold)


buyer_names = ["CÔNG TY TNHH THƯƠNG MẠI ALPHA", "CÔNG TY CỔ PHẦN BETA", "DOANH NGHIỆP TƯ NHÂN GAMMA"]
...
print(f"Successfully generated 30 mock invoices (MISA, FAST, DEFAULT) and 30 Perfect Ground Truths.")
